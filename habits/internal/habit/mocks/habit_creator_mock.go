...
//go:generate minimock -i learngo-pockets/habits/internal/habit.habitCreator -o habit_creator_mock.go -n HabitCreatorMock -p mocks
	...
	if mmAdd.AddMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmAdd.t.Errorf("HabitCreatorMock.Add got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.habit != nil && !minimock.Equal(*mm_want_ptrs.habit, mm_got.habit) {
				mmAdd.t.Errorf("HabitCreatorMock.Add got unexpected parameter habit, want: %#v, got: %#v%s\n", *mm_want_ptrs.habit, mm_got.habit, minimock.Diff(*mm_want_ptrs.habit, mm_got.habit))
			}
